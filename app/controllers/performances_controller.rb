...
def index
    ...
    .where("time > ?", Time.now)
    .order('time ASC')
	@years = {"2012-2013" => {"videoID" => "xDUMIMu7Ojg", "awards" => ["2nd Place - ATown Showdown"], "videos" => ["http://www.youtube.com/watch?v=ypDAKsCmUcg", "http://www.youtube.com/watch?v=lpQPRE-RfA8 "]}, 
